{
	'variables':
	{
		...
		[
			'src/java/com/hyperxtalk/android/AccelerationChangeListener.java',
			'src/java/com/hyperxtalk/android/Alert.java',
			'src/java/com/hyperxtalk/android/AppProvider.java',
			'src/java/com/hyperxtalk/android/BitmapView.java',
			'src/java/com/hyperxtalk/android/BusyIndicator.java',
			'src/java/com/hyperxtalk/android/CalendarEvents.java',
			'src/java/com/hyperxtalk/android/CameraCompat.java',
			'src/java/com/hyperxtalk/android/Contact.java',
			'src/java/com/hyperxtalk/android/DialogModule.java',
			'src/java/com/hyperxtalk/android/Email.java',
			'src/java/com/hyperxtalk/android/Engine.java',
			'src/java/com/hyperxtalk/android/EngineApi.java',
			'src/java/com/hyperxtalk/android/EngineReceiver.java',
			'src/java/com/hyperxtalk/android/FileProvider.java',
			'src/java/com/hyperxtalk/android/LCBInvocationHandler.java',
			'src/java/com/hyperxtalk/android/HyperXTalkActivity.java',
			'src/java/com/hyperxtalk/android/HyperXTalkService.java',
			'src/java/com/hyperxtalk/android/NetworkModule.java',
			'src/java/com/hyperxtalk/android/NFCModule.java',
			'src/java/com/hyperxtalk/android/NotificationModule.java',
			'src/java/com/hyperxtalk/android/OpenGLView.java',
			'src/java/com/hyperxtalk/android/PushReceiver.java',
			'src/java/com/hyperxtalk/android/ScreenOrientationEventListener.java',
			'src/java/com/hyperxtalk/android/SensorModule.java',
			'src/java/com/hyperxtalk/android/ShakeEventListener.java',
			'src/java/com/hyperxtalk/android/SoundModule.java',
			'src/java/com/hyperxtalk/android/TextMessaging.java',
			'src/java/com/hyperxtalk/android/URLLoader.java',
			'src/java/com/hyperxtalk/android/Utils.java',
			'src/java/com/hyperxtalk/android/billing/BillingProvider.java',
			'src/java/com/hyperxtalk/android/billing/BillingModule.java',
			'src/java/com/hyperxtalk/android/billing/PurchaseObserver.java',
			#'src/java/com/hyperxtalk/android/billing/ResponseHandler.java',
			'src/java/com/hyperxtalk/android/billing/google/Base64.java',
			'src/java/com/hyperxtalk/android/billing/google/Base64DecoderException.java',
			'src/java/com/hyperxtalk/android/billing/google/IabException.java',
			'src/java/com/hyperxtalk/android/billing/google/IabHelper.java',
			'src/java/com/hyperxtalk/android/billing/google/IabResult.java',
			'src/java/com/hyperxtalk/android/billing/google/Inventory.java',
			'src/java/com/hyperxtalk/android/billing/google/Purchase.java',
			'src/java/com/hyperxtalk/android/billing/google/SkuDetails.java',
			'src/java/com/hyperxtalk/android/billing/google/Security.java',
			'src/java/com/hyperxtalk/android/billing/google/GoogleBillingProvider.java',
			'src/java/com/hyperxtalk/android/billing/samsung/SamsungBillingProvider.java',
			'src/java/com/hyperxtalk/android/nativecontrol/BrowserControl.java',
			'src/java/com/hyperxtalk/android/nativecontrol/ExtVideoView.java',
			'src/java/com/hyperxtalk/android/nativecontrol/InputControl.java',
			'src/java/com/hyperxtalk/android/nativecontrol/InputView.java',
			'src/java/com/hyperxtalk/android/nativecontrol/NativeControl.java',
			'src/java/com/hyperxtalk/android/nativecontrol/NativeControlModule.java',
			'src/java/com/hyperxtalk/android/nativecontrol/ScrollerControl.java',
			'src/java/com/hyperxtalk/android/nativecontrol/VideoControl.java',
			
			'src/java/com/hyperxtalk/android/libraries/LibBrowser.java',
		],
		...
		[
			'src/java/com/hyperxtalk/android/billing/amazon/AmazonBillingProvider.java',
			'src/java/com/hyperxtalk/android/billing/amazon/MyPurchasingObserver.java',
		],
