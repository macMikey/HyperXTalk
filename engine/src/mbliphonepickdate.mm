...
@interface com_hyperxtalk_hyperxtalk_MCIPhonePickDateWheelDelegate : UIViewController <UIPickerViewDelegate, UIPickerViewDataSource, UIActionSheetDelegate, UITableViewDelegate, UIPopoverControllerDelegate>
{
	bool iSiPad;
	bool m_running;
...
@implementation com_hyperxtalk_hyperxtalk_MCIPhonePickDateWheelDelegate
...
static com_hyperxtalk_hyperxtalk_MCIPhonePickDateWheelDelegate *s_pick_date_wheel_delegate = nil;
...
struct datepicker_t
{
	...
	com_hyperxtalk_hyperxtalk_MCIPhonePickDateWheelDelegate *picker;
	bool cancelled;
};
...
static void pickdate_prewait(void *p_context)
{
	...
	ctxt -> picker = [[com_hyperxtalk_hyperxtalk_MCIPhonePickDateWheelDelegate alloc] init];
