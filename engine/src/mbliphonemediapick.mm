...
@interface com_hyperxtalk_hyperxtalk_MCIPhonePickMediaDelegate : UIViewController <MPMediaPickerControllerDelegate, UIPopoverControllerDelegate>
{
	bool m_running;
...
@implementation com_hyperxtalk_hyperxtalk_MCIPhonePickMediaDelegate
...
#ifndef __i386__
	__block com_hyperxtalk_hyperxtalk_MCIPhonePickMediaDelegate *t_media_picker;
	__block NSArray *t_result_data;
	t_result_data = nil;
    MCIPhoneRunBlockOnMainFiber(^(void) {
        t_media_picker = [[com_hyperxtalk_hyperxtalk_MCIPhonePickMediaDelegate alloc] init];
    });
