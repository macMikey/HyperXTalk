...
@interface com_hyperxtalk_hyperxtalk_MCSystemUrlDelegate : NSObject
{
...
@implementation com_hyperxtalk_hyperxtalk_MCSystemUrlDelegate
...
static void do_system_load_url(void *p_ctxt)
{
	...
	com_hyperxtalk_hyperxtalk_MCSystemUrlDelegate *t_delegate;
	t_delegate = nil;
	if (t_success)
	{
		t_delegate = [[com_hyperxtalk_hyperxtalk_MCSystemUrlDelegate alloc] initWithCallback: ctxt -> callback context: ctxt -> context];
		if (t_delegate == nil)
			t_success = false;
	}
...
@interface com_hyperxtalk_hyperxtalk_MCPostUrlTimeoutMonitor : NSObject
{
	NSURLConnection *m_connection;
	NSTimer *m_timer;
	com_hyperxtalk_hyperxtalk_MCSystemUrlDelegate *m_delegate;
}
@end

@implementation com_hyperxtalk_hyperxtalk_MCPostUrlTimeoutMonitor
- (com_hyperxtalk_hyperxtalk_MCPostUrlTimeoutMonitor*) initWithTimeInterval:(NSTimeInterval)interval withConnection:(NSURLConnection*)connection withDelegate:(com_hyperxtalk_hyperxtalk_MCSystemUrlDelegate*)delegate
{
	self = [super init];
	if (self)
	{
...
static void do_post_url(void *p_ctxt)
{
	...
	NSData *t_data = nil;
	com_hyperxtalk_hyperxtalk_MCSystemUrlDelegate *t_delegate = nil;
	com_hyperxtalk_hyperxtalk_MCPostUrlTimeoutMonitor *t_timeout_monitor = nil;
	...
	if (t_success)
	{
		t_timeout_monitor = [[com_hyperxtalk_hyperxtalk_MCPostUrlTimeoutMonitor alloc] initWithTimeInterval: MCsockettimeout withConnection:t_connection
...
@interface com_hyperxtalk_hyperxtalk_MCPutFTPUrlTimeoutMonitor : NSObject
{
...
@implementation com_hyperxtalk_hyperxtalk_MCPutFTPUrlTimeoutMonitor
- (com_hyperxtalk_hyperxtalk_MCPutFTPUrlTimeoutMonitor*) initWithTimeInterval:(NSTimeInterval)interval withStream:(CFWriteStreamRef)stream withContext:(FTPClientCallbackData*)context;
{
	self = [super init];
	if (self)
	{
...
bool MCSystemPutFTPUrl(NSURL *p_url, const void *p_data, uint32_t p_length, MCSystemUrlCallback p_callback, void *p_context)
{
	...
	com_hyperxtalk_hyperxtalk_MCPutFTPUrlTimeoutMonitor *t_monitor = nil;
	...
	if (t_success)
	{
		...
		t_success = nil != (t_monitor = [[com_hyperxtalk_hyperxtalk_MCPutFTPUrlTimeoutMonitor alloc] initWithTimeInterval:MCsockettimeout withStream:t_ftp_stream withContext:t_context]);
	}
	if (t_success)
	{
