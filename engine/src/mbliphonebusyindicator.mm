...
@interface com_hyperxtalk_hyperxtalk_MCBusyIndicator : NSObject <UIApplicationDelegate, UIActionSheetDelegate>
{
...
static com_hyperxtalk_hyperxtalk_MCBusyIndicator *s_busy_indicator = nil;

@implementation com_hyperxtalk_hyperxtalk_MCBusyIndicator
...
bool MCSystemBusyIndicatorStart (intenum_t p_indicator, MCStringRef p_label, int32_t p_opacity)
{
    switch (p_indicator)
    {
        ...
        case kMCBusyIndicatorSquare:
        {
            ...
            s_busy_indicator = [[com_hyperxtalk_hyperxtalk_MCBusyIndicator alloc] init];
            if (p_label == nil)
