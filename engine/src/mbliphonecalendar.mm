...
#ifdef __IPHONE_4_0
@interface com_hyperxtalk_hyperxtalk_MCIPhonePickEventDelegate : UIViewController <EKEventEditViewDelegate>
#else
@interface com_hyperxtalk_hyperxtalk_MCIPhonePickEventDelegate : UIViewController <EKEventEditViewDelegate, EKEventViewDelegate>
#endif
{
    bool m_running;
...
@implementation com_hyperxtalk_hyperxtalk_MCIPhonePickEventDelegate
...
bool MCSystemShowEvent(MCStringRef p_event_id, MCStringRef& r_result)
{
    ...
    com_hyperxtalk_hyperxtalk_MCIPhonePickEventDelegate *t_show_event;
    t_show_event = [[com_hyperxtalk_hyperxtalk_MCIPhonePickEventDelegate alloc] init];
...
bool MCSystemCreateEvent(MCStringRef& r_result)
{
    bool t_result = false;
    NSString* t_ns_result = nil;
    com_hyperxtalk_hyperxtalk_MCIPhonePickEventDelegate *t_create_event;
    t_create_event = [[com_hyperxtalk_hyperxtalk_MCIPhonePickEventDelegate alloc] init];
...
bool MCSystemUpdateEvent(MCStringRef p_event_id, MCStringRef& r_result)
{
    ...
    NSString* t_ns_result = nil; 
    NSString* t_ns_event = MCStringConvertToAutoreleasedNSString(p_event_id);
    com_hyperxtalk_hyperxtalk_MCIPhonePickEventDelegate *t_update_event;
    t_update_event = [[com_hyperxtalk_hyperxtalk_MCIPhonePickEventDelegate alloc] init];
...
bool MCSystemGetEventData(MCExecContext &r_ctxt, MCStringRef p_event_id, MCArrayRef &r_event_data)
{
    ...
    com_hyperxtalk_hyperxtalk_MCIPhonePickEventDelegate *t_get_event;
    t_get_event = [[com_hyperxtalk_hyperxtalk_MCIPhonePickEventDelegate alloc] init];
...
bool MCSystemRemoveEvent(MCStringRef p_event_id, bool p_reocurring, MCStringRef& r_event_id_deleted)
{
    ...
    NSString* t_ns_event = MCStringConvertToAutoreleasedNSString(p_event_id);
    com_hyperxtalk_hyperxtalk_MCIPhonePickEventDelegate *t_delete_event;
    t_delete_event = [[com_hyperxtalk_hyperxtalk_MCIPhonePickEventDelegate alloc] init];
...
bool MCSystemAddEvent(MCCalendar p_new_calendar_data, MCStringRef& r_result)
{
    bool t_result = false;
    NSString* t_ns_result = NULL;
    com_hyperxtalk_hyperxtalk_MCIPhonePickEventDelegate *t_add_event;
    t_add_event = [[com_hyperxtalk_hyperxtalk_MCIPhonePickEventDelegate alloc] init];
...
bool MCSystemGetCalendarsEvent(MCStringRef& r_result)
{
    bool t_result = false;
    NSString* t_ns_result = NULL;
    com_hyperxtalk_hyperxtalk_MCIPhonePickEventDelegate *t_get_calendars_event;
    t_get_calendars_event = [[com_hyperxtalk_hyperxtalk_MCIPhonePickEventDelegate alloc] init];
...
bool MCSystemFindEvent(MCDateTime p_start_date, MCDateTime p_end_date, MCStringRef& r_result)
{
    ...
    {
        com_hyperxtalk_hyperxtalk_MCIPhonePickEventDelegate *t_find_event;
        t_find_event = [[com_hyperxtalk_hyperxtalk_MCIPhonePickEventDelegate alloc] init];
